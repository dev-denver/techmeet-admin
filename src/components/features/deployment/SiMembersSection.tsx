            ...
            {members.length === 0 ? (
              ...
              members.map((m) => (
                ...
                >
                  ...
                  <TableCell className="hidden lg:table-cell"><Badge variant="outline">SI</Badge></TableCell>
        ...
        {members.length === 0 ? (
          ...
          members.map((m) => (
            ...
            >
              ...
              <div className="mt-1 text-sm text-muted-foreground">{m.site} · {m.project_name}</div>
              {m.detail_work && (
