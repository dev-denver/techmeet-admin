...
import { deploymentProjectMemberCreateSchema } from "@/lib/api/schemas";
...
export async function POST(request: NextRequest) {
  ...
  const { data: body, error: parseError } = await parseBody(request, deploymentProjectMemberCreateSchema);
